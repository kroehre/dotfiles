...
BREWS=(ack universal-ctags chruby codeburn font-iosevka-nerd-font gh ghostty git-delta jq lazygit markdown neovim redis ruby-install the_silver_searcher tmux wget)
for b in ${BREWS[@]}; do
